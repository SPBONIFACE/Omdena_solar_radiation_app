'''
Create an application using Heroku and Streamlit to prediction solar radiation
in Boulogne - Billancourt (greater Paris)
'''
...
This app predicts solar radiation in Boulogne-Billancourt based on solar and weather data.

Data was retried for [Solcast](https://solcast.com/).
...
if st.button('Predict'):
    ...
    st.write(f"The forecasted radiation is {np.round(prediction,2)}")
